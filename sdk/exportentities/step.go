...
type Step struct {
	...
	Release          *StepRelease          `json:"release,omitempty" yaml:"release,omitempty"`
	JUnitReport      *StepJUnitReport      `json:"jUnitReport,omitempty" yaml:"jUnitReport,omitempty"`
	Checkout         *StepCheckout         `json:"checkout,omitempty" yaml:"checkout,omitempty"`
	Deploy           *StepDeploy           `json:"deploy,omitempty" yaml:"deploy,omitempty"`
